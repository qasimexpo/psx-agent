...
> Free halal stock research for the PSX. Daily brief, AI picks screened against the KMI index, portfolio audit.
...
3. **The index diagram** (`frontend/public/images/guides/psx-indices.svg`, export as PNG) with:
   > KSE-100 tells you a company is big. It does not tell you it is halal. Three PSX indices, one diagram. smartsarmaya.com/guides/kse-100-vs-kmi-30-vs-kmi-all-shares
