# Facebook posts — Tuesday 22 September 2026

Three feature posts. The video is the one to boost; the other two are ordinary posts for later in the week. Every caption ends with the disclaimer line — keep it.

---

## 1 · Portfolio audit video — `audit-demo.mp4` (boost this one)
...
**PPL declared a 60% final dividend. What does that actually pay you?**

Not 60% of the price. PSX dividends are quoted on the Rs 10 par value, so 60% = Rs 6 per share.

400 shares × Rs 6 = Rs 2,400 gross
Withholding tax, filer 15% = − Rs 360
Paid to you = Rs 2,040
Yield at Rs 228 = 2.6%

Non-filers pay 30% withholding, so being on the ATL is worth sorting out before dividend season.

Run your own numbers with the free dividend calculator (capital-gains tax and investment-growth calculators on the same page) → https://www.smartsarmaya.com/calculators
...
You must hold the shares before the book-closure date to receive it. Educational only, not tax advice.
#PSX #Dividends #PPL #PakistanStockExchange

---

## 3 · Introduction — `intro-what-it-does.jpg` (for groups and the Page)

**Assalam o Alaikum everyone.** I'm Qasim, a retail investor on the PSX like most of you. Over the last few months I built a free AI website for the questions that come up in groups like this every day, and I'd like to share it.
...
Everything is free with no account. It is educational only – not financial advice, not a religious ruling, and nobody can tell you for certain whether the market goes up or down tomorrow. What it gives you is the data to decide for yourself instead of depending on tips.

If you want a symbol checked, drop it in the comments and I'll reply with the page.

---

## Answering comments

`python marketing/social/reply.py OGDC LUCK MARI` prints a paste-ready English and Roman Urdu reply per symbol from the live page.
